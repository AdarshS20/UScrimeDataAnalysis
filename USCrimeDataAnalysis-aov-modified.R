...
#Data with is_south and one with that removed
#Remove the variable is_south categorical variable
UScrime.new<-UScrime.data_clean
UScrime.data_clean<-subset(UScrime.data_clean,select = -c(is_South))
...
#Simple Regression on the all 15 independent variables
...
# Simple Regression for crime rate vs Percent Male
UScrime.percentmale.lm<-lm(crime_rate~Percent_Male,data = UScrime.data_clean)
summary(UScrime.percentmale.lm)
anova(UScrime.percentmale.lm)

# Simple Regression for crime rate vs Mean Education
UScrime.meanedu.lm<-lm(crime_rate~mean_Education,data = UScrime.data_clean)
summary(UScrime.meanedu.lm)
anova(UScrime.meanedu.lm)
...
# Simple Regression for crime rate vs Labour force participation rate
UScrime.labourfp.lm<-lm(crime_rate~labour_fp,data = UScrime.data_clean)
summary(UScrime.labourfp.lm)
anova(UScrime.labourfp.lm)

# Simple Regression for crime rate vs Number of Males per 1000 Females
UScrime.nomal_f.lm<-lm(crime_rate~no_mal_1000_f,data = UScrime.data_clean)
summary(UScrime.nomal_f.lm)
anova(UScrime.nomal_f.lm)

# Simple Regression for crime rate vs Number of Non whites per 1000 people
UScrime.nonwhites.lm<-lm(crime_rate~nonWhites_per1000,data = UScrime.data_clean)
summary(UScrime.nonwhites.lm)
anova(UScrime.nonwhites.lm)

# Simple Regression for crime rate vs Unemployment Rate of Urban Males 14-24
UScrime.unemployu24.lm<-lm(crime_rate~unemploy_urb_m24,data = UScrime.data_clean)
summary(UScrime.unemployu24.lm)
anova(UScrime.unemployu24.lm)

# Simple Regression for crime rate vs Unemployment Rate of Urban Males 35-39
UScrime.unemployu39.lm<-lm(crime_rate~unemploy_urb_m39,data = UScrime.data_clean)
summary(UScrime.unemployu39.lm)
anova(UScrime.unemployu39.lm)

# Simple Regression for crime rate vs income inequality
UScrime.incomeine.lm<-lm(crime_rate~inequality,data = UScrime.data_clean)
summary(UScrime.incomeine.lm)
anova(UScrime.incomeine.lm)

# Simple Regression for crime rate vs average time served in state prisons
UScrime.timestatepri.lm<-lm(crime_rate~time_state_pri,data = UScrime.data_clean)
summary(UScrime.timestatepri.lm)
anova(UScrime.timestatepri.lm)

# Simple Regression for crime rate vs indicator variable for a Southern state
UScrime.is_south.lm<-lm(crime_rate~is_South,data = UScrime.new)
summary(UScrime.is_south.lm)
anova(UScrime.is_south.lm)
...
anova(UScrime.dt.modint)
#UScrime.dt.modint

# Interaction between variables - 1
UScrime.dt.modint.m1<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp),data = UScrime.data_clean)
summary(UScrime.dt.modint.m1)
anova(UScrime.dt.modint.m1)
#UScrime.dt.modint.m1

# Interaction between variables - 2
UScrime.dt.modint.m2<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop),data = UScrime.data_clean)
summary(UScrime.dt.modint.m2)
anova(UScrime.dt.modint.m2)

# Interaction between variables - 3
UScrime.dt.modint.m3<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop),data = UScrime.data_clean)
summary(UScrime.dt.modint.m3)
anova(UScrime.dt.modint.m3)

# Interaction between variables - 4
UScrime.dt.modint.m4<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp),data = UScrime.data_clean)
summary(UScrime.dt.modint.m4)
anova(UScrime.dt.modint.m4)

# Interaction between variables - 5
UScrime.dt.modint.m5<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp),data = UScrime.data_clean)
summary(UScrime.dt.modint.m5)
anova(UScrime.dt.modint.m5)

# Interaction between variables - 6
UScrime.dt.modint.m6<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) , data = UScrime.data_clean)
summary(UScrime.dt.modint.m6)
anova(UScrime.dt.modint.m6)


# Interaction between variables - 7
UScrime.dt.modint.m7<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) -(pol_exp:gdp:state_pop), data = UScrime.data_clean)
summary(UScrime.dt.modint.m7)
anova(UScrime.dt.modint.m7)


# Interaction between variables - 8
UScrime.dt.modint.m8<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) -(pol_exp:gdp:state_pop) - (pol_exp:prob_imp:state_pop), data = UScrime.data_clean)
summary(UScrime.dt.modint.m8)
anova(UScrime.dt.modint.m8)

# Interaction between variables - 9
UScrime.dt.modint.m9<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) -(pol_exp:gdp:state_pop) - (pol_exp:prob_imp:state_pop) -(gdp:prob_imp:state_pop), data = UScrime.data_clean)
summary(UScrime.dt.modint.m9)
anova(UScrime.dt.modint.m9)

# Interaction between variables - 10
UScrime.dt.modint.m10<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) -(pol_exp:gdp:state_pop) - (pol_exp:prob_imp:state_pop) -(gdp:prob_imp:state_pop) - (pol_exp:state_pop), data = UScrime.data_clean)
summary(UScrime.dt.modint.m10)
anova(UScrime.dt.modint.m10)

# Interaction between variables - 11
UScrime.dt.modint.m11<-aov(crime_rate~pol_exp*gdp*prob_imp*state_pop - (pol_exp:prob_imp) - (prob_imp:state_pop) - (state_pop) - (gdp:prob_imp) - (pol_exp:gdp:prob_imp) - (pol_exp:gdp) -(pol_exp:gdp:state_pop) - (pol_exp:prob_imp:state_pop) -(gdp:prob_imp:state_pop) - (pol_exp:state_pop) -(gdp:state_pop), data = UScrime.data_clean)
summary(UScrime.dt.modint.m11)
anova(UScrime.dt.modint.m11)


#Check
UScrime.dt.modint1<-lm(crime_rate~pol_exp*gdp*prob_imp*state_pop,data = UScrime.data_clean)
summary(UScrime.dt.modint1)
anova(UScrime.dt.modint1)

#Run anova for 3 parameters
# Model 7 - crime rate vs Police expenditure * Gdp*probability of imprisonment
UScrime.dt.modi1<-lm(crime_rate~pol_exp*gdp*prob_imp,data = UScrime.data_clean)
summary(UScrime.dt.modi1)
anova(UScrime.dt.modi1)

UScrime.dt.modi2<-aov(crime_rate~pol_exp*gdp*prob_imp,data = UScrime.data_clean)
summary(UScrime.dt.modi2)
...
anova(UScrime.dt.mod1,UScrime.dt.mod2,UScrime.dt.mod3,UScrime.dt.mod4,UScrime.dt.mod5,UScrime.dt.mod6,UScrime.dt.modint1)

#Based on AIC
library(AICcmodavg)
model.set<-list(UScrime.dt.mod1,UScrime.dt.mod2,UScrime.dt.mod3,UScrime.dt.mod4,UScrime.dt.mod5,UScrime.dt.mod6,UScrime.dt.modint1)
model.names<-c("1,2","1,3","1,4","2,3","2,4","3,4","1*2*3*4")
aictab(model.set,modnames = model.names)

#Checking 
model.set<-list(UScrime.dt.modint1,UScrime.dt.modi1)
model.names<-c("4*","3*")
aictab(model.set,modnames = model.names)
...
#Checking 
anova(UScrime.dt.modint1,UScrime.dt.modi1,UScrime.dt.mod7)
model.set<-list(UScrime.dt.modint1,UScrime.dt.modi1,UScrime.dt.mod7)
model.names<-c("pol_exp*gdp*prob_imp*state_pop","pol_exp*gdp*prob_imp","pol_exp+gdp+prob_imp")
aictab(model.set,modnames = model.names)
